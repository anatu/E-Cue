...
// Background 5 Scene Changer Logic
// Modified to hard-code the names of successor scenes

public class SceneChange_BG5 : MonoBehaviour
{
	...
	*****************************/
	...
	private string DetermineSuccessor(string decision)
	{
		...
		string successor = "Scene_" + decision;		
		return successor;
	}
